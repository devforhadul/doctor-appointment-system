...
const Navbar = () => {
  ...
  return (
    ...
    <div className="navbar sticky top-0 bg-white shadow z-50">
      <div className="basis-2/3 navbar-start mr-3 flex justify-between">
        ...
        <div>
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <NavLink to="/doctors" className={({ isActive }) => `${isActive ? 'text-indigo-600 border-b-2' : ''} `}>Doctors</NavLink>
            </li>

            <li className={user || 'hidden'}>
              <NavLink to="/my-bookings" className={({ isActive }) => `${isActive ? 'text-indigo-600 border-b-2' : ''} `}>My Bookings</NavLink>
